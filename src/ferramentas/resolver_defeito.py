...
def busca_dados_de_resolucao(etiqueta):
    return {
        "resolucao":"Para resolver esse problema. Por favor, retire a solda."
    }
...
class ResolverDefeito(BaseTool):
    
    name:str = "ResolverDefeito"
    description:str = """Esta ferramenta mostra como resolver defeitos de uma etiqueta ER. Passe para essa ferramenta como argumento a etiqueta ER."""
    ...
    def _run(self, input: str) -> str:
        ...
        dados = busca_dados_de_resolucao(etiqueta)
